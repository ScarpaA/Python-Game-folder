...
pygame.display.set_caption("Monstrum Simplified")
...
def testDeplacement(touche):
    global x,y,d,start, showmap
    if touche in ['a','z','e','q','s','d','m']:
        if (((touche == 'd' and d==0) or (touche == 'z' and d==1)or(touche == 'q' and d==2)or(touche == 's' and d==3)) and  tableau[y][x+1] != '0' ):
            x=x+1
        elif (((touche == 'z' and d==0) or (touche == 'q' and d==1)or(touche == 's' and d==2)or(touche == 'd' and d==3)) and  tableau[y-1][x] != '0' ):
            y=y-1
        elif (((touche == 'q' and d==0) or (touche == 's' and d==1)or(touche == 'd' and d==2)or(touche == 'z' and d==3)) and  tableau[y][x-1] != '0' ):
            x=x-1
        elif (((touche == 's' and d==0) or (touche == 'd' and d==1)or(touche == 'z' and d==2)or(touche == 'q' and d==3)) and  tableau[y+1][x] != '0' ):
            y=y+1
        elif touche == 'e':
            d=(d+1)%4
        elif touche == 'a':
            ...
            if showmap==1:
                ...
                pygame.draw.rect(fenetre, NOIR, [450,0,1000,105])
                showmap=0
        if x==3 and y==12:
            start=time.clock()
            tableau[14][8]='1'
